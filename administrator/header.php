        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li class="active">
                        ...
                        <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-tasks"></span> Administrator yang sedang masuk sekarang (<?php echo $_SESSION['username'];?>) <span class="caret"></span>
                        </a>
                        ...
                        <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-tasks"></span> Kelola Data Yayasan <span class="caret"></span>
                        </a>
                            <ul class="dropdown-menu">
                                <li><a href="data-pengguna.php">Data Pengguna</a></li>
                                <li><a href="data-pengurus.php">Data Pengurus</a></li>
                                <li><a href="kelola-informasi.php">Informasi Terbaru</a></li>
                            </ul>
                        </li>
          </ul>
      </div>
